...
public final class ConfigurationUtils {
     ...
     * @throws IllegalArgumentException if the input stream contains incorrect value type
     */
    public static <T extends PulsarConfiguration> T create(
     ...
     *
     * @param properties which key-value pair of properties to assign those values to given object
     * @param obj object which needs to be updated
     * @throws IllegalArgumentException if the properties key-value contains incorrect value type
     */
